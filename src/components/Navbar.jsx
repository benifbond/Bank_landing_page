...
const Navbar = () => {
  ...
  return (
    <nav className="w-full flex py-6 justify-between items-center navbar">
      ...
      <ul className='list-none sm:flex hidden justify-end items-center fley-1'>
    ...
    object-contain"
        ...
        <div className={`${toggle ? "flex" : "hidden"
          } p-6 bg-black-gradient absolute top-20 right-0 my-4 my-2 min-w-[140px] rounded-xl sidebar`} >
          <ul className='list-none flex  justify-end items-center fley-1 flex-col'>
            {navLinks.map((nav, index) => (
